...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JanrainUser.url'
        db.alter_column('janrain_janrainuser', 'url', self.gf('django.db.models.fields.URLField')(max_length=512, null=True))
        # Adding unique constraint on 'JanrainUser', fields ['user']
        db.create_unique('janrain_janrainuser', ['user_id'])


        # Changing field 'JanrainUser.provider'
        db.alter_column('janrain_janrainuser', 'provider', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'JanrainUser.url'
        db.alter_column('janrain_janrainuser', 'url', self.gf('django.db.models.fields.URLField')(default='', max_length=512))

        # Changing field 'JanrainUser.provider'
        db.alter_column('janrain_janrainuser', 'provider', self.gf('django.db.models.fields.CharField')(default=None, max_length=64))
